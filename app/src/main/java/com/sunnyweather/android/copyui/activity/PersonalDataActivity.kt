...
import com.sunnyweather.android.http.api.UpdateImageApi
import com.sunnyweather.android.http.glide.GlideApp
import com.sunnyweather.android.http.model.HttpData
import com.sunnyweather.android.copyui.dialog.AddressDialog
...
class PersonalDataActivity : AppActivity() {
    ...
    override fun onClick(view: View) {
        if (view === avatarLayout) {
            ...
            if (avatarUrl != null) {
                // 查看头像
                ImagePreviewActivity.Companion.start(this, avatarUrl.toString())
            } else {
                avatarLayout?.let {
                    // 选择头像
                    onClick(it)
