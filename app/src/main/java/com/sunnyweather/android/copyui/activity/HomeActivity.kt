...
import com.sunnyweather.android.copyui.adapter.NavigationAdapter
import com.sunnyweather.android.copyui.fragment.FindFragment
import com.sunnyweather.android.copyui.fragment.HomeFragment
import com.sunnyweather.android.copyui.fragment.MessageFragment
import com.sunnyweather.android.copyui.fragment.MineFragment
import com.sunnyweather.android.manager.ActivityManager
import com.sunnyweather.android.other.DoubleClickHelper
...
class HomeActivity : AppActivity(), NavigationAdapter.OnNavigationListener {
    ...
    override fun initView() {
        navigationAdapter = NavigationAdapter(this).apply {
            ...
            addItem(
                NavigationAdapter.MenuItem(getString(R.string.home_nav_message),
