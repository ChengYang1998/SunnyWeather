...
import com.sunnyweather.android.http.api.GetCodeApi
import com.sunnyweather.android.http.api.RegisterApi
            ...
            activity.startActivityForResult(intent, object : OnActivityCallback {
                ...
                override fun onActivityResult(resultCode: Int, data: Intent?) {
                    ...
                    if (resultCode == RESULT_OK) {
                        listener.onSucceed(data.getStringExtra(INTENT_KEY_PHONE), data.getStringExtra(
                            INTENT_KEY_PASSWORD
                        ))
                    } else {
                        listener.onCancel()
